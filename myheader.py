...
def headerRnd():
    ...
    rndheader=USER_AGENT_LIST[random.randint(0,len(USER_AGENT_LIST))%len(USER_AGENT_LIST)]
    return rndheader
def headerRQ():
    USER_AGENT_LIST=[
        "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.1 (KHTML, like Gecko) Chrome/22.0.1207.1 Safari/537.1",
    ...
    header=USER_AGENT_LIST[random.randint(0,len(USER_AGENT_LIST))%len(USER_AGENT_LIST)]
